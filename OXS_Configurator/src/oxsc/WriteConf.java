...
public class WriteConf {
	...
	public static void writeConf() {
		...
		try {
			...
			//e.printStackTrace();
			System.out.println("Problem with config file writing !!");
		}
		
		output.println("// Configuration file generated by openXsensor Configurator " + Validation.getOxsCversion() + " the: " + MainP.day + "-" + MainP.month + "-" + PApplet.year() ) ;
