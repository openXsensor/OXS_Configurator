...
//			TabData.populateSentDataFields() ;
	...
	public void writeConf() {
		...
		output.println("// Configuration file generated by openXsensor Configurator " + Validation.getOxsCversion() + " the: " + day + "-" + month + "-" + year() ) ;
